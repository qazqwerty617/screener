(function (root) {
  ...
  const themes = [
    ...
    { id: 'terminal', name: 'Изумруд', description: 'Тёмный нефрит · аквамарин и коралл', bg: '#071411', panel: '#0d201b', raised: '#143029', hover: '#1d4439', text: '#e5f4ee', muted: '#8fb5a7', border: '#285247', accent: '#37d6a2', onAccent: '#062019', up: '#55e6b5', down: '#ff7d83', wickUp: '#9af3d3', wickDown: '#ffb3b6', volumeUp: '#2d9c7b', volumeDown: '#ad555f', grid: '#1b382f', mapBg: '#030c0a', mapPanel: '#0b1d18', arbitrageBg: '#06110e', arbitragePanel: '#0d211b', formationsBg: '#06130f', formationsPanel: '#10261f', light: false },
    { id: 'ice', name: 'Токио', description: 'Ночной индиго · неон и сакура', bg: '#0c1024', panel: '#141a35', raised: '#1d2647', hover: '#29345d', text: '#edf1ff', muted: '#9ca8cf', border: '#35416d', accent: '#58d7ff', onAccent: '#071621', up: '#59e0ff', down: '#ff6fae', wickUp: '#a8eeff', wickDown: '#ffafd0', volumeUp: '#357fba', volumeDown: '#a94779', grid: '#252e53', mapBg: '#070a19', mapPanel: '#121831', arbitrageBg: '#090d20', arbitragePanel: '#151b36', formationsBg: '#090d20', formationsPanel: '#171e3b', light: false },
    { id: 'carbon', name: 'Карбон', description: 'Матовый графит · кобальт и серебро', bg: '#111315', panel: '#181b1f', raised: '#22262b', hover: '#2c3239', text: '#f2f4f7', muted: '#a5adb8', border: '#3a414a', accent: '#6e9dff', onAccent: '#071226', up: '#dfe5ed', down: '#607086', wickUp: '#ffffff', wickDown: '#9ca9b8', volumeUp: '#7c8ea5', volumeDown: '#465568', grid: '#2b3036', mapBg: '#0b0d0f', mapPanel: '#171a1e', arbitrageBg: '#0d0f12', arbitragePanel: '#191c20', formationsBg: '#0d0f12', formationsPanel: '#1a1e23', light: false },
  ];
